...
import net.net63.codearcade.LSD.listeners.WorldContactListener;
...
public class GameWorld implements Disposable, EntityListener {
    ...
    private void addSystems() {
        ...
        engine.addSystem(new PlayerSystem(levelDescriptor, world, gameEventSignal));
        ...
        engine.addSystem(new LaserSystem(gameCamera, world, gameEventSignal));
    ...
    private void addListeners() {
        ...
        world.setContactListener(new WorldContactListener(world, gameEventSignal));
